...
class ApiConfig {
  ...
  static String collectionAssignmentHistory(int id) =>
      '/collection-requests/$id/assignments';
  ...
  static String reportCollectionIssue(int id) =>
      '/collections/$id/report-issue';
  ...
  static String feedbacksByReport(int reportId) =>
