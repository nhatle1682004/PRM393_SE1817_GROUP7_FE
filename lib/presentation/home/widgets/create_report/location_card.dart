...
class _LocationCardState extends State<LocationCard> {
  ...
  void initState() {
    ...
    if (widget.lat != null && widget.lng != null && widget.currentAddress == null) {
  ...
  void didUpdateWidget(LocationCard oldWidget) {
    ...
    if (widget.lat != oldWidget.lat || widget.lng != oldWidget.lng) {
      ...
      if (widget.currentAddress != null && widget.currentAddress != _displayedAddress) {
        _displayedAddress = widget.currentAddress;
        // Only update search text if it's a search result, not GPS
        if (!_isFromGps) {
          _searchController.text = widget.currentAddress!;
        }
      } else if (widget.lat != null && widget.lng != null && !_isFetchingAddress) {
        _fetchAddress(widget.lat!, widget.lng!);
      }
      if (widget.lat != null && widget.lng != null) {
    ...
    if (widget.currentAddress != oldWidget.currentAddress && widget.currentAddress != null) {
      _displayedAddress = widget.currentAddress;
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.symmetric(
                  horizontal: 16, vertical: widget.isMobile ? 12 : 14),
