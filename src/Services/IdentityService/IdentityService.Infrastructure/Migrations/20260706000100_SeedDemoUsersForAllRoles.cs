...
-- Identity demo users. All passwords are: Password123!
UPDATE identity.roles SET role_name = 'Citizen', description = 'Regular citizen user' WHERE role_id = 1;
UPDATE identity.roles SET role_name = 'Enterprise', description = 'Enterprise account' WHERE role_id = 2;
UPDATE identity.roles SET role_name = 'Collector', description = 'Waste collector' WHERE role_id = 3;
UPDATE identity.roles SET role_name = 'Admin', description = 'System administrator' WHERE role_id = 4;

INSERT INTO identity.users (user_id, role_id, full_name, email, password, phone, status, created_at, total_points)
VALUES
  (9001, 1, 'Demo Citizen', 'citizen@example.com', '$2a$10$/xxbO9TBUyJ3AgYeR4k/pO8Q372Rtfnw8SdkJbtuS3nKUOeaY6RDq', '0900000001', 'Active', TIMESTAMP '2026-01-01 00:00:00', 120),
  (9002, 2, 'Demo Enterprise', 'enterprise@example.com', '$2a$10$/xxbO9TBUyJ3AgYeR4k/pO8Q372Rtfnw8SdkJbtuS3nKUOeaY6RDq', '0900000002', 'Active', TIMESTAMP '2026-01-01 00:00:00', 0),
  (9003, 3, 'Demo Collector', 'collector@example.com', '$2a$10$/xxbO9TBUyJ3AgYeR4k/pO8Q372Rtfnw8SdkJbtuS3nKUOeaY6RDq', '0900000003', 'Active', TIMESTAMP '2026-01-01 00:00:00', 0),
  (9004, 4, 'Demo Admin', 'admin@example.com', '$2a$10$/xxbO9TBUyJ3AgYeR4k/pO8Q372Rtfnw8SdkJbtuS3nKUOeaY6RDq', '0900000004', 'Active', TIMESTAMP '2026-01-01 00:00:00', 0)
